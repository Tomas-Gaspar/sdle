...
powershell -Command "netstat -ano | findstr ':5556 :3000 :3001 :5000' | ForEach-Object { ($_ -split '\s+')[5] } | Select-Object -Unique | ForEach-Object { taskkill /PID $_ /F }"
...
REM Launch the fourth terminal for Server
